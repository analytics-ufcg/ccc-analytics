...
files = ['historico-ccc.csv']

src_prefix = '/home/tercio/Downloads/'
dest_prefix = 'ccc-analytics-2.0/ccc2/data/'

# 'id_mapping' faz um mapeamento de cada matricula
# para o id a ela atribuído.
id_mapping = {}
for pair in open('ccc-analytics-2.0/ccc2/data/matriculas').readlines():
    id, mat = pair.split(' ')
    id_mapping[mat[:-1]] = id
