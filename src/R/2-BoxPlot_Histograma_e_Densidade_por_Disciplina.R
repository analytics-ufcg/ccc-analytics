library(ggplot2)
d = read.csv("C:/CCC/CCC/Dados/notas.txt",sep = "\t", encoding = "UTF-8")
...
for(i in 1:length(dsc)){
  ...
  nome =  gsub("(","_",nome,fixed=TRUE) 
  nome =  gsub(")","_",nome,fixed=TRUE)   
  mypath <- file.path(paste("C:/Users/Larissa/Documents/GitHub/ccc/plots/2-BoxPlot/DSC/", nome, ".png", sep = ""))
...
for(i in 1:length(outros)){
  ...
  nome =  gsub("(","_",nome,fixed=TRUE) 
  nome =  gsub(")","_",nome,fixed=TRUE) 
  mypath <- file.path(paste("C:/Users/Larissa/Documents/GitHub/ccc/plots/2-BoxPlot/Outros/", nome, ".png", sep = ""))
  png(file=mypath, width = 900)
...
for(i in 1:length(dsc)){
  ...
  nome =  gsub("(","_",nome,fixed=TRUE) 
  nome =  gsub(")","_",nome,fixed=TRUE)   
  mypath <- file.path(paste("C:/Users/Larissa/Documents/GitHub/ccc/plots/2-Histograma/DSC/", nome, ".png", sep = ""))
  png(file=mypath, width = 900)
...
for(i in 1:length(outros)){
  ...
  nome =  gsub("(","_",nome,fixed=TRUE) 
  nome =  gsub(")","_",nome,fixed=TRUE)   
  mypath <- file.path(paste("C:/Users/Larissa/Documents/GitHub/ccc/plots/2-Histograma/Outros/", nome, ".png", sep = ""))
  png(file=mypath, width = 900)
...
for(i in 1:length(dsc)){
  ...
  nome =  gsub("(","_",nome,fixed=TRUE) 
  nome =  gsub(")","_",nome,fixed=TRUE)   
  mypath <- file.path(paste("C:/Users/Larissa/Documents/GitHub/ccc/plots/2-Densidade/DSC/", nome, ".png", sep = ""))
  png(file=mypath, width = 900)
...
for(i in 24:length(outros)){
  ...
  nome =  gsub("(","_",nome,fixed=TRUE) 
  nome =  gsub(")","_",nome,fixed=TRUE)   
  mypath <- file.path(paste("C:/Users/Larissa/Documents/GitHub/ccc/plots/2-Densidade/Outros/", nome, ".png", sep = ""))
  png(file=mypath, width = 900)
