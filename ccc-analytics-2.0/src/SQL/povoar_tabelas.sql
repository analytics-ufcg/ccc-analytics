...
COPY Aluno (MatriculaAluno) FROM LOCAL 'ccc-analytics-2.0/ccc2/data/CSVtoDatabase/TabelaAlunos.csv' WITH DELIMITER ',';

COPY DisciplinaAluno (CodigoDisciplina, MatriculaAluno, NomeDisciplina, Periodo, Optativa, Nota1, Nota2, Nota3, Media, Final, Situacao, PeriodoRelativo) FROM LOCAL 'ccc-analytics-2.0/ccc2/data/CSVtoDatabase/TabelasDisciplinas.csv' WITH DELIMITER ',';
...
COPY GradeDisciplinasPorPeriodo (Periodo, NomeDisciplina, CodigoDisciplina) FROM LOCAL 'ccc-analytics-2.0/ccc2/data/grade-disciplinas-por-periodo.csv' WITH DELIMITER ',';
