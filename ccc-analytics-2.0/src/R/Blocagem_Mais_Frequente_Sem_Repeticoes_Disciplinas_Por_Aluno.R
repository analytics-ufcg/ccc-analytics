# Dado um periodo letivo qualquer e o periodo de entrada no curso esta funÃ§Ã£o retorna um numero que representa o periodo relativo ao periodo de entrada.
# O formato do periodo deve ser 3 digitos, os dois primeiros para o ano e o terceiro para o semestre.
# Ex. Um aluno entrou no curso no periodo 2011.1 e estÃ¡ em 2013.2, entao as entradas devem ser 111 e 132, respectivamente. A saÃ­da seria 5 (quinto perÃ­odo).
...
#Deve-se setar o Working Directory, setwd(), para o diretÃ³rio "ccc-analytics-2.0" antes de esecutar este script
...
#DefiniÃ§Ãµes de funÃ§Ãµes Ãºteis neste 
maxn <- function(n) function(x) order(x, decreasing = TRUE)[n]
valorMaxn <- function(n) function(x) x[order(x, decreasing = TRUE)][n]

#colunas que contem as frequencias dos perÃ­odos
colunasUteis = 3:18
...
#Vetor com a maior frequencia da disciplina observada em um perÃ­odo letivo
