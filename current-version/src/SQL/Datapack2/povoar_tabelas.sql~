...
COPY Disciplina (CodigoDisciplina, NomeDisciplina, CodigoDepto, Obrigatoria, Nome) FROM LOCAL '/home/tales/development/ccc/ccc-analytics-2.0/data/CSVtoDatabase/Datapack2/TabelaDisciplina.csv' WITH DELIMITER ',';
